...
/**
 * Job: j_sample Purpose: For demo of GIT pull & push<br>
 ...
 * @status
 */
public class j_sample implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "j_sample.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(j_sample.class);
	...
	private final String jobName = "j_sample";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(j_sample.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final j_sample j_sampleClass = new j_sample();

		int exitCode = j_sampleClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'j_sample' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'j_sample' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = j_sample.class.getClassLoader()
					.getResourceAsStream("demo/j_sample_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = j_sample.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : j_sample");
		}
		if (enableLogStash) {
